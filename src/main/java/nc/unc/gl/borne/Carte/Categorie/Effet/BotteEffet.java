...
public enum BotteEffet {
    VEHICULE_PRIORITAIRE("Immunise contre les attaques de limites de vitesse", "botte_vitesse.jpeg"),
    CITERNE_ESSENCE("Immunise contre les attaques de panne d'essence", "botte_essence.jpeg"),
    INCREVABLE("Immunise contre les attaques de crevaison", "botte_crevaison.jpeg"),
    AS_DU_VOLANT("Immunise contre les attaques accident", "botte_accident.jpeg");
